...
Similar to linear regression, one of the simplest family of classifiers is that of linear predictors. In such, we are interested in separating a given dataset into two classes using a linear separator function, as seen in \autoref{lin_sep1}.
