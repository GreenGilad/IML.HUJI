...
\begin{figure}[h!]
	...
	\caption{\textbf{LDA Decision Boundaries} for a multiclass setup of three Gaussians}
	\label{lda_decision_boundary}
\end{figure}

\paragraph{Learning An LDA Classifier}
...
\begin{eqnarray}
\widehat{\pi}^{MLE} &\coloneqq &\frac{1}{m}\sum \indc{y_i = 1} = \frac{m_1}{m} \\
