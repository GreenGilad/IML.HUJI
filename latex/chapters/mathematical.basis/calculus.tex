...
Note that at $x=0$ the derivative of ReLU is undefined. We will discuss ways to handle such cases in \todo{add reference to sub gradients, chapter 8}. Next, let us expand the derivative definition to multivariate functions.
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.5]{chapters/mathematical.basis/figures/max_3D.png}
	\includegraphics[scale=0.5]{chapters/mathematical.basis/figures/max_2D.png}
	\caption{\todo{Change these images}}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.5]{chapters/mathematical.basis/figures/polynomial_3D.png}  
	\includegraphics[scale=0.5]{chapters/mathematical.basis/figures/polynomial_2D.png}
	\caption{\todo{Change these images}}
\end{figure}
...
\todo{add visualization of gradients}
...
\todo{add chain rule in the simple case}
...
\end{bmatrix}
$$
In element-wise notation  $$J_{\x}\left(f\circ g\right)_{i,j} = \sum_l\frac{\partial f_i\left(g\left(\x\right)\right)}{\partial g_l\left(\x\right)}  \frac{\partial g_l\left(\x\right)}{\partial x_j} $$
\end{theorem}
