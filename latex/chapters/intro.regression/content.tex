...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.8\textwidth]{chapters/intro.regression/figures/polyfit-scheme.png}
...
\begin{figure}[h!]
	...
	\caption{\textbf{Polynomial Fitting:} Fitted polynomial of degree $1$ over different datasets differing only in values of added sample noise. \todo{reference to github code}}\label{anim:poly1}
\end{figure}
...
\begin{figure}[h!]
	...
	\caption{\textbf{Polynomial Fitting:} Fitted polynomial of degree $8$ over different datasets differing only in values of added sample noise\todo{reference to github code}}\label{anim:poly8}
\end{figure}
