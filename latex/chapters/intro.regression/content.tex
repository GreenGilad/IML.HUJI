...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.5\textwidth]{chapters/intro.regression/figures/2_4.png}
	\includegraphics[width=0.5\textwidth]{chapters/intro.regression/figures/2_5.png}
	\caption{\textbf{\todo{add caption}}}
\end{figure}
